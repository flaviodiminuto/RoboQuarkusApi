// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection10
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection10#deploy_0
    RETURN
    ** label2
