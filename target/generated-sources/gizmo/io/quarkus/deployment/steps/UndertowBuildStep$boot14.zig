// Class: io/quarkus/deployment/steps/UndertowBuildStep$boot14
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$boot14#deploy_0
    RETURN
    ** label2
