// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties12
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties12#deploy_0
    RETURN
    ** label2
